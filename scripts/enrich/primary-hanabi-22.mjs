...
patchAll([
  ...
  ['aomori-006-summer-ar0202e188528', {
    ...
    venue: { name: '八戸市中心商店街（十三日町・三日町・ヤグラ横町）', address: '青森県八戸市' },
  ...
  ['akita-005-hanabi-ar0205e467443', {
    ...
    venue: { name: '協和船岡 上宇津野地内', address: '秋田県大仙市協和船岡字上宇津野地内' },
  ...
  ['chiba-003-summer-ar0312e73552', {
    ...
    venue: { name: '八坂神社周辺', address: '千葉県香取郡多古町多古' },
  ...
  ['fukuoka-001-summer-ar1040e112128', {
    ...
    venue: { name: '志井公園', address: '福岡県北九州市小倉南区志井公園' },
  ...
  ['gunma-001-goguynet-62376', {
    ...
    venue: { name: '伊勢崎駅南口駅前広場', address: '群馬県伊勢崎市今泉町二丁目' },
  ...
  ['ota-summer-ar0310e4773', {
    ...
    venue: { name: '尾島商店街大通り（県道142号線）周辺', address: '群馬県太田市尾島町' },
  ...
  ['tatebayashi-summer-ar0310e305050', {
    ...
    venue: { name: '本町通り', address: '群馬県館林市本町' },
