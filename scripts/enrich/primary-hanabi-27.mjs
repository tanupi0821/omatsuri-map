...
patchAll([
  ...
  ['saitama-001-summer-ar0311e72577', {
    ...
    station: 'JR川越線 日進駅南口',
    venue: { name: '日進七夕通り周辺・日進小学校校庭', address: 'さいたま市北区日進町' },
  ...
  ['saitama-003-summer-ar0311e72219', {
    ...
    station: 'JR・東武 大宮駅',
    venue: { name: '大宮駅東口周辺', address: 'さいたま市大宮区' },
  ...
  ['saitama-002-summer-ar0311e357292', {
    ...
    venue: { name: '長瀞岩畳', address: '秩父郡長瀞町長瀞' },
  ...
  ['hiratsuka-shonan-hiratsuka-tanabata', {
    ...
    venue: { name: '平塚市中心街および市内各所', address: '平塚市' },
  ...
  ['ebina-hanabi-ar0314e00451', {
    ...
    venue: { name: '海老名運動公園', address: '海老名市' },
  ...
  ['gifu-001-summer-ar0621e74987', {
    venue: { name: '本町・大垣駅通り', address: '大垣市' },
  ...
  ['hokkaido-013-summer-ar0101e510355', {
    venue: { name: '旧JR新冠駅前広場周辺', address: '新冠郡新冠町' },
  ...
  ['akishima-goguynet-126490', {
    ...
    venue: { name: 'JR昭島駅北口 モリタウン北側特設会場', address: '昭島市田中町562-1' },
