...
patchAll([
  ...
  ['kumamoto-012-hanabi-ar1043e01051', {
    venue: { name: '球磨川河川緑地（新萩原橋上流）', address: '熊本県八代市' },
    links: [
  ...
  ['kagoshima-003-hanabi-ar1046e00998', {
    ...
    venue: { name: '川内川河川敷一帯（西開聞町〜大小路町）', address: '鹿児島県薩摩川内市西開聞町' },
    links: [
  ...
  ['oita-005-hanabi-ar1044e00983', {
    ...
    venue: { name: '大分川 弁天大橋上流', address: '大分県大分市' },
    links: [
  ...
  ['oita-011-hanabi-ar1044e00990', {
    ...
    venue: { name: '北浜緑地帯（打上げは別府湾沖）', address: '大分県別府市北浜' },
    links: [
  ...
  ['hiroshima-002-hanabi-ar0834e00984', {
    ...
    venue: { name: '芦田川大橋上流', address: '広島県福山市' },
    links: [
  ...
  ['hiroshima-008-hanabi-ar0834e00696', {
    organizer: '広島祭委員会',
    venue: { name: '広島港 1万トンバース沖', address: '広島県広島市南区宇品海岸3丁目' },
    links: [
  ...
  ['yamaguchi-009-hanabi-ar0835e01001', {
    ...
    venue: { name: '宇部港', address: '山口県宇部市港町一丁目15番28号' },
    links: [
