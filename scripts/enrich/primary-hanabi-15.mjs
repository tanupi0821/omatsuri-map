...
patchAll([
  ...
  ['kagawa-003-hanabi-ar0937e00702', {
    ...
    venue: { name: '高松港 玉藻防波堤', address: '高松市' },
  ...
  ['kagawa-006-hanabi-ar0937e00628', {
    organizer: '丸亀市',
    venue: { name: 'レオマリゾート園内', address: '丸亀市綾歌町栗熊西40-1' },
  ...
  ['kochi-001-hanabi-ar0939e00705', {
    ...
    venue: { name: '鏡川河畔（みどりの広場）', address: '高知市' },
  ...
  ['kochi-004-hanabi-ar0939e00706', {
    ...
    venue: { name: '四万十川お祭り広場（赤鉄橋たもとの四万十川河川敷）', address: '四万十市' },
  ...
  ['kumamoto-011-hanabi-ar1043e00953', {
    venue: { name: '菊池川 高瀬大橋一帯', address: '玉名市高瀬' },
  ...
  ['nagano-004-hanabi-ar0420e513309', {
    station: 'JR小海線 中込駅',
    venue: { name: '千曲川河川敷（佐久大橋〜野沢橋間）', address: '佐久市' },
  ...
  ['nagano-011-hanabi-ar0420e00685', {
    ...
    venue: { name: '千曲川河川敷（常田新橋下流）', address: '上田市常田1丁目' },
  ...
  ['ishikawa-003-hanabi-ar0517e00674', {
    venue: { name: '手取川河川敷', address: '能美郡川北町' },
  ...
  ['miyagi-005-hanabi-ar0204e00623', {
    ...
    venue: { name: 'やまいちサステナパーク七北田公園（七北田川河川敷周辺）', address: '仙台市泉区' },
  ...
  ['nagasaki-008-hanabi-ar1042e00946', {
    ...
    station: '島原鉄道 島原港駅',
    venue: { name: '島原港（島原外港南側防波堤）', address: '島原市下川尻町7-5' },
