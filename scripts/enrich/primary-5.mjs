...
patchAll([
  ...
  // **静岡県熱海市泉字塩坪72-1**。この祭りは神奈川県湯河原町に置かれているが、
  // 伊豆湯河原温泉は県境を越えた熱海市泉にある。
  // 住所は事実として入れ、食い違いを note に残す（area の付け替えは影響が大きいので触らない）
  ['yugawara-izu-yugawara-noryo-hanabi', {
    ...
    occurrence: {
      ...
      note: '和太鼓19時40分から、手筒花火20時20分から、打上花火20時40分から。'
        + '会場の泉公園は県境を越えた静岡県熱海市泉にある（この祭りは神奈川県湯河原町として載せている）',
    },
  }],
